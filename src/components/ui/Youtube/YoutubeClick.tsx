...
export default function Youtube({ video, title, thumbnail }: Props) {
  ...
  return (
    <>
      <div
        ...
        } youtube-container aspect-w-16 aspect-h-9`}
      >
        <iframe
          width="100%"
          height="450"
      ...
      <div
        ...
        } duration-300 bg-black relative youtube-container aspect-w-16 aspect-h-9 group`}
        onClick={handleClick}
      >
        <span className="absolute inset-0 z-50 p-3 font-sans text-lg font-medium text-left text-white duration-300 group-hover:opacity-0">
          {title}
        </span>
        ...
        <img
          ...
          loading="lazy"
          height="720"
          className="pointer-events-none opacity-30 group-hover:opacity-100"
        />
      </div>
    </>
  );
